...
/**
 * Verbatim payload from the assignment brief. Rendered exactly as given —
 * see README "Assumptions" for the internal inconsistencies found between
 * this data and the mockups (e.g. parent totals not equal to the sum of
 * their children in some months). We deliberately do not "fix" any values
 * here; each node is displayed using its own `values` as-is.
 */
export const company: ClientNode = {
